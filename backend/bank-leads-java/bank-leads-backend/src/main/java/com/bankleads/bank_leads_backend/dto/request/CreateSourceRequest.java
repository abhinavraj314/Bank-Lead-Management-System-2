...
public class CreateSourceRequest {
    ...
    /**
     * Optional list of columns describing what data the source provides.
     * Validation (at least one column) is enforced in the controller so that
     * existing clients without this field can be handled gracefully if needed.
     */
